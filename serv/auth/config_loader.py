        ...
        try:
            ...
            for component_type, component in components.items():
                if isinstance(component, list):
                    ...
                    logger.info(f"Configured {component_type}: {type(component).__name__}")
...
def configure_auth_from_app_config(app_config: Dict[str, Any], container: Container) -> AuthConfigLoader:
    """
