...
def AuditRequired(pipeline_requirement: Union[AuditEventType, AuditEventGroup, AuditPipeline, AuditPipelineSet]):
    """
...
def _validate_audit_pipeline(requirement: Union[AuditEventType, AuditEventGroup, AuditPipeline, AuditPipelineSet], 
