...
class HomeRoute(Route):
    ...
    @injectable
    async def show_home(
        self, request: GetRequest, db: Inject[Ommi, Options(qualifier="blog")]
...
class CreatePostRoute(Route):
    ...
    async def create_post(
        self, request: PostRequest, db: Inject[Ommi, Options(qualifier="blog")]
    ) -> Annotated[tuple[str, dict[str, str]], Jinja2Response]:
