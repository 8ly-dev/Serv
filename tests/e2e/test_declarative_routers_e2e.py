...
'''
            ...
            "routers": [
                {
                    ...
                    "routes": [
                        ...
                        {
                            "path": "/goodbye",
                            "handler": "handlers:GoodbyeHandler"
                        }
                    ]
                }
            ]
            ...
            "routers": [
                ...
                },
                {
                    ...
                    "routes": [
                        {
                            "path": "/dashboard",
                            "handler": "admin:DashboardHandler"
                        }
                    ]
                }
            ]
    ...
    @pytest.mark.asyncio
    async def test_multiple_plugins_with_declarative_routers_e2e(self, test_project_dir):
            ...
            "routers": [
                {
                    ...
                    "routes": [
                        {
                            "path": "/products",
                            "handler": "shop:ProductsHandler"
                        },
                        {
                            "path": "/cart",
                            "handler": "shop:CartHandler"
                        }
                    ]
                }
            ]
...
'''
        ...
        async with create_test_client(app_factory=lambda: app) as client:
            ...
            assert json_data["auth_required"] == False
            ...
            assert json_data["auth_required"] == True
            assert json_data["admin_only"] == True
