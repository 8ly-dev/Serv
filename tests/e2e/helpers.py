...
import asyncio
import contextlib
from typing import AsyncGenerator, Optional, Callable, Any, Dict, List, Union
...
@asynccontextmanager
async def lifespan_context(app: App) -> AsyncGenerator[None, None]:
    """
    ...
    lifespan_task = asyncio.create_task(
        app.handle_lifespan(scope, receive, send)
    )
