...
"""
        ...
        assert loaded_plugin_config["name"] == "test-plugin", "Plugin name should match expected value"
        assert loaded_plugin_config["display_name"] == "Test Plugin", "Display name should match expected value"
        assert loaded_plugin_config["version"] == "1.0.0", "Version should match expected value"
