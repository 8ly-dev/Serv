...
class TestAdvancedAnnotationHandling:
    ...
    def test_qualified_string_annotation(self, mock_store):
        ...
        async def create_user(
            username: str, emitter: "serv.auth.audit.enforcement.AuditEmitter"
        ) -> str:
    ...
    def test_union_string_annotation(self, mock_store):
        ...
        async def create_session(
            user_id: str, audit: "AuditEmitter | None" = None
        ) -> str:
            if audit:
    ...
    def test_typing_union_string_annotation(self, mock_store):
        ...
        async def authenticate(
            creds: str, emitter: "Union[AuditEmitter, None]" = None
        ) -> bool:
            if emitter:
    ...
    def test_reverse_union_string_annotation(self, mock_store):
        ...
        async def delete_user(
            user_id: str, tracker: "None | AuditEmitter" = None
        ) -> bool:
            if tracker:
    ...
    def test_complex_union_string_annotation(self, mock_store):
        ...
        async def update_creds(
            user_id: str, logger: "AuditEmitter | str | None" = None
        ) -> bool:
    ...
    def test_annotation_detection_without_decorator(self):
        ...
        def test_func(param1: str, emitter: "AuditJournal | None" = None) -> bool:
            return True
